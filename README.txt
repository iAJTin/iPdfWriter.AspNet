...
iPdfWriter.AspNet, extends iPdfWriter to work in AspNet (FullFramework) projects, contains extension methods to download PdfInput instances 
...
· Added
  -----
    ...
    •—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————•
    | iTin.AspNet.Web                       1.0.0.0     Base class library for booth AspNet & AspNetCore environments         |
    •—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————————•
...
For more information, please see https://www.nuget.org/packages/iPdfWriter.AspNet/


Documentation
=============

 - Please see next link https://github.com/iAJTin/iPdfWriter.AspNet/blob/master/documentation/iTin.Utilities.Pdf.Writer.AspNet.md
